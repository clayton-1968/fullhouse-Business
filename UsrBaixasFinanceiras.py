...
class BaixasFinanceiras(Widgets, Consultas_Financeiro, Pessoas, Produtos, Icons):
    ...
    def criar_widgets_baixas_financeiras(self):
        ...
        self.fr_botao_box.place(relx=0.76, rely=0, relwidth=0.185, relheight=0.07)
        ...
        self.entry_contacorrente.bind("<Return>", lambda event: self.muda_barrinha(event, self.entry_dt_baixa))
