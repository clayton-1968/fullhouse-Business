...
class ExtratoBancario(Widgets, Consultas_Financeiro, Pessoas, Produtos, Icons):
    ...
    def create_widgets(self):
        ...
        self.fr_agencia.place(relx=0.51, rely=0, relwidth=0.14, relheight=0.09)
        ...
        self.fr_contacorrente.place(relx=0.655, rely=0, relwidth=0.14, relheight=0.09)
        ...
        self.contascorrente = []
        self.entry_contacorrente = AutocompleteCombobox(self.fr_contacorrente, width=30, justify=tk.LEFT, font=('Times', 11),
